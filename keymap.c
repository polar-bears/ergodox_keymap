 ...
 *
 * ,--------------------------------------------------.           ,--------------------------------------------------.
 * |   `    |   1  |   2  |   3  |   4  |   5  | DEL  |           | FN0  |   6  |   7  |   8  |   9  |   0  |   -    |
 * |--------+------+------+------+------+-------------|           |------+------+------+------+------+------+--------|
 * | Tab    |   Q  |   W  |   E  |   R  |   T  |  F1  |           |  F7  |   Y  |   U  |   I  |   O  |   P  |   \    |
 * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
 * | Cmd    |   A  |   S  |   D  |   F  |   G  |------|           |------|   H  |   J  |   K  |   L  |   ;  |' / Cmd |
 * |--------+------+------+------+------+------| Esc  |           | F10  |------+------+------+------+------+--------|
 * | LShift |Z/Ctrl|   X  |   C  |   V  |   B  |      |           |      |   N  |   M  |   ,  |   .  |//Ctrl| RShift |
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   | Hyper| Meh  |  ALT |  Cmd |   =  |                                       |EscL2 |   [  |   ]  | ALT  |EscL1 |
 *   `----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,-------------.
 *                                        |Enter | LGui |       | Back |  DEL |
 *                                 ,------|------|------|       |------+--------+------.
...
[BASE] = KEYMAP(  // layer 0 : default
        ...
        ALL_T(KC_NO),   MEH_T(KC_NO), KC_LALT,KC_LGUI,KC_EQL,
                                                      KC_ENT,         KC_LGUI,
                                                                      KC_HOME,
                                                      KC_SPC, KC_BSPC,KC_END,
        // right hand
        KC_FN0,   KC_6,   KC_7,    KC_8,     KC_9,    KC_0,            KC_MINS,
        KC_F7,    KC_Y,   KC_U,    KC_I,     KC_O,    KC_P,            KC_BSLS,
                  KC_H,   KC_J,    KC_K,     KC_L,    KC_SCLN,         GUI_T(KC_QUOT),
        KC_F10,   KC_N,   KC_M,    KC_COMM,  KC_DOT,  CTL_T(KC_SLSH),  KC_RSFT,
                  LT(MDIA,KC_ESC), KC_LBRC,  KC_RBRC, KC_RALT,         LT(SYMB,KC_ESC),
        KC_BSPC,          KC_DELT,
        KC_PGUP,
